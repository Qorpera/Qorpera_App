  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] flex items-center justify-center rounded-full bg-accent text-accent-ink text-[10px] font-bold px-1">
