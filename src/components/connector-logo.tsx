export function ConnectorLogo({ provider, size = 20 }: { provider: string; size?: number }) {
  ...
  if (p === "cargowise") return (
    <svg width={s} height={s} viewBox="0 0 24 24"><rect rx="4" width="24" height="24" fill="#1B365D"/><text x="12" y="15" textAnchor="middle" fill="#fff" fontSize="6" fontWeight="700">CW</text></svg>
  );
  if (p === "maersk") return (
    <svg width={s} height={s} viewBox="0 0 24 24"><rect rx="4" width="24" height="24" fill="#42B0D5"/><text x="12" y="15" textAnchor="middle" fill="#fff" fontSize="5" fontWeight="700">MAERSK</text></svg>
  );
  ...
  if (p === "dynamics-bc") return (
    <svg width={s} height={s} viewBox="0 0 24 24"><rect rx="4" width="24" height="24" fill="#003C88"/><text x="12" y="16" textAnchor="middle" fill="#fff" fontSize="9" fontWeight="700">BC</text></svg>
  );
