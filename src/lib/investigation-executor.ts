...
8. **Consult reference material when needed.** When investigating specific domains, the system reference library (search_wiki scope "system") has practitioner-specific material — benchmarks, methodology frameworks, empirical patterns, Danish/Nordic practice. Consult it when you encounter specifics where practitioner reference would help, not as a prerequisite to investigating.
...
- **search_wiki** — search the knowledge base. Use scope "system" for practitioner reference material (benchmarks, methodologies, empirical patterns), scope "operator" for company-specific knowledge
