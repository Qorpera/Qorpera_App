...
const INITIATIVE: PageSchema = {
  ...
  sectionMenu: [
    "Proposal", "Rationale", "Expected Impact", "Effort & Requirements",
    "Alternatives Considered", "Implementation Plan", "Evaluation Criteria", "Current Status",
  ],
  properties: {
    status: { type: "enum", required: true, owner: "synthesis", enumValues: ["proposed", "evaluating", "approved", "implementing", "implemented", "rejected", "deferred"], description: "Initiative status" },
